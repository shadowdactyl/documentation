...
![](../../../.vuepress/public/community/config/nodes/shadowdactyl_add_node_create_button.png)

## Information Required

![](../../../.vuepress/public/community/config/nodes/shadowdactyl_add_node_new_page.png)
...
this time.
* **FQDN**: the fully qualified domain name for the node — for example: `node.shadowdactyl.io`
...
generate. By default this is `/var/lib/shadowdactyl/volumes`.

::: tip OVH Users
Some OVH users regularly have their `/home` folder be the largest filesystem. You may want to change to use
`/home/shadowdactyl/volumes` if you are on a default OVH box.
:::
...
![](../../../.vuepress/public/community/config/nodes/shadowdactyl_add_node_config.png)

Copy and paste the config into the `config.yml` file. (Default location is `/etc/shadowdactyl/config.yml`)
