...
to ensure that you're in the `/var/www/shadowdactyl` directory as the command below will automatically unpack in whatever
directory you are currently in.

``` bash
curl -L https://github.com/shadowdactyl/panel/releases/download/v0.7.19/panel.tar.gz | tar --strip-components=1 -xzv
```
...
Previous versions of Shadowdactyl attempted to cache your configuration file for speed and performance enhancements. This
...
::: warning
Running `db:seed` below will overwrite any changes you made to core Shadowdactyl Nests, Eggs, or Egg Variables! This is
